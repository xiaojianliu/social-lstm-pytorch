...
f = open('/home/hesl/Desktop/KITTITrackinData/0017-pred/results.pkl', 'rb')
results = pickle.load(f)

'''Append Y GT'''
f = open('/home/hesl/Desktop/KITTITrackinData/0017-pred/y_ground_truth/results.pkl', 'rb')
...
#[7,16]
#
# '''Visualize KITTI Ground Truth (u,v)'''
#
# for j in range(len(data_loader.frameList[0])):
#
#     sourceFileName = "/home/hesl/Desktop/KITTITrackinData/0016/" + str(int(data_loader.frameList[0][j] )).zfill(6) + ".png"
#
...
#
#     for i in range(data_loader.numPedsList[0][j]):
#          v=int(data_loader.data[0][j][i][2])
#          u=int(data_loader.data[0][j][i][1])
#          if u!=0 and v!=0:
#              print(u, v)
#
#          cv2.rectangle(avatar, (u  - 2, v  - 2), (u+ 2, v + 2), green,thickness=-1)
#
#     imagename = '/home/hesl/Desktop/KITTITrackinData/0016-GT/' + str(int(data_loader.frameList[0][j] )).zfill(6) + ".jpg"
...
#         #print('k = {}'.format(k))
#         #print('filename:',)
#         sourceFileName = videopath[sample_args.visual_dataset] + "frame-" + str(int(data_loader.frameList[0][
#                                                                                         count + j * skip_frame + k * (
...
#
#         cv2.imshow("avatar", avatar)
#         imagename='/home/hesl/PycharmProjects/social-lstm-pytorch/plot/FixedPixel_Normalized_150epoch/'+str(sample_args.visual_dataset)+'/visualize-'+ str(int(data_loader.frameList[0][count+j*skip_frame+k*(sample_args.obs_length+sample_args.pred_length)*skip_frame])).zfill(3) + ".jpg"
#         #print(imagename)
#
#         #cv2.imwrite(imagename, avatar)
#         #print(t)
    ...
    for j in range(sample_args.obs_length+sample_args.pred_length):
        ...
        for i in range(len(results[k][2][j])):
            ...
            if x!=0 or z!=0:
                ...
                z = (z + 1) *(28.3571 * 0.5) +2.6694
                x = (x + 1) *(14.2367 *0.5) - 9.4110
            ...
            if xp != 0 or zp != 0:
                zp = (zp + 1)*(28.3571 * 0.5) +2.6694
                xp = (xp + 1)*(14.2367 *0.5) - 9.4110
        ...
        #cv2.imshow("avatar", avatar)
        imagename='/home/hesl/Desktop/KITTITrackinData/0017-pred/visualize-'+ str(int(data_loader.frameList[0][j*skip_frame+k*(sample_args.obs_length+sample_args.pred_length)*skip_frame])).zfill(6) + ".jpg"
        #print(imagename)
